...
const SvgMath = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M10.5 8.81H6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4.5c.41 0 .75.34.75.75s-.34.75-.75.75M18 14.81h-4.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75H18c.41 0 .75.34.75.75s-.34.75-.75.75M18 18.56h-4.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75H18c.41 0 .75.34.75.75s-.34.75-.75.75M18 7.31h-1.48v-1.5c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5H13.5c-.41 0-.75.34-.75.75s.34.75.75.75h1.52v1.5c0 .41.34.75.75.75s.75-.34.75-.75v-1.5H18c.41 0 .75-.34.75-.75s-.34-.75-.75-.75M9.31 15.94l1.72-1.72c.29-.29.29-.77 0-1.06a.755.755 0 0 0-1.06 0l-1.72 1.72-1.72-1.72a.754.754 0 0 0-1.06 0c-.29.29-.29.77 0 1.06l1.72 1.72-1.72 1.72c-.29.29-.29.77 0 1.06.15.15.34.22.53.22s.38-.07.53-.22L8.25 17l1.72 1.72c.15.15.34.22.53.22s.38-.07.53-.22c.29-.29.29-.77 0-1.06z"
    />
  </svg>
);
