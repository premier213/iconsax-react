...
const SvgSearchFavorite = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M11 20.75c-5.38 0-9.75-4.37-9.75-9.75S5.62 1.25 11 1.25c.41 0 .75.34.75.75s-.34.75-.75.75c-4.55 0-8.25 3.7-8.25 8.25s3.7 8.25 8.25 8.25 8.25-3.7 8.25-8.25c0-.41.34-.75.75-.75s.75.34.75.75c0 5.38-4.37 9.75-9.75 9.75"
    />
    <path
      fill="currentColor"
      d="M16.5 9.54c-.92 0-3.06-1.12-3.72-3.18-.45-1.41.07-3.26 1.7-3.79.7-.23 1.43-.12 2.01.25.57-.37 1.32-.47 2.02-.25 1.63.53 2.16 2.38 1.7 3.79-.65 2.1-2.9 3.18-3.71 3.18m-2.29-3.63c.46 1.45 2.02 2.11 2.3 2.14.32-.03 1.85-.77 2.27-2.13.23-.73 0-1.67-.73-1.91-.31-.1-.73-.04-.93.25a.745.745 0 0 1-1.23.03c-.23-.33-.65-.38-.95-.29-.72.24-.96 1.18-.73 1.91M20.16 22.79c-.08 0-.16-.01-.23-.02-.47-.06-1.32-.38-1.8-1.81-.25-.75-.16-1.5.25-2.07s1.1-.89 1.89-.89c1.02 0 1.82.39 2.18 1.08s.26 1.57-.31 2.42c-.71 1.07-1.48 1.29-1.98 1.29m-.6-2.3c.17.52.41.78.57.8s.46-.17.77-.62c.29-.43.31-.74.24-.88s-.35-.29-.87-.29c-.31 0-.54.1-.67.27-.12.17-.14.43-.04.72"
    />
  </svg>
);
