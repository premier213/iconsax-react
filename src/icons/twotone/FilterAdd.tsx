...
const SvgFilterAdd = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M21.63 14.75c0 .89-.25 1.73-.69 2.45a4.71 4.71 0 0 1-4.06 2.3 4.73 4.73 0 0 1-4.06-2.3 4.66 4.66 0 0 1-.69-2.45c0-2.62 2.13-4.75 4.75-4.75s4.75 2.13 4.75 4.75M18.66 14.73h-3.55M16.879 13v3.55"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
