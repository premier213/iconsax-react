...
const SvgHomeHashtag = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12.7 16.88h.7c1.15 0 2.09-.94 2.09-2.09v-.7H12.7zM8.51 14.79c0 1.15.94 2.09 2.09 2.09h.7v-2.79H8.51zM8.51 12v.7h2.79V9.91h-.7c-1.15 0-2.09.94-2.09 2.09"
    />
    <path
      fill="currentColor"
