...
const SvgGalleryTick = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M17.46 7.2c-.19 0-.38-.07-.53-.22l-1.46-1.46a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l.93.93 3.37-3.37c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-3.9 3.9c-.14.15-.34.22-.53.22M2.67 19.7a.746.746 0 0 1-.41-1.37l4.93-3.31c1.08-.73 2.57-.64 3.55.19l.33.29c.5.43 1.35.43 1.84 0l4.16-3.57c1.06-.91 2.73-.91 3.8 0l1.63 1.4c.31.27.35.74.08 1.06-.27.31-.74.35-1.06.08l-1.63-1.4c-.5-.43-1.35-.43-1.85 0l-4.16 3.57c-1.06.91-2.73.91-3.8 0l-.33-.29c-.46-.39-1.22-.43-1.73-.08l-4.93 3.31c-.13.08-.28.12-.42.12"
    />
  </svg>
);
