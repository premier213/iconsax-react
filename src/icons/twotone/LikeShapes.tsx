...
const SvgLikeShapes = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g stroke="currentColor" strokeWidth={1.5} opacity={0.4}>
      <path
        strokeMiterlimit={10}
        d="m9.891 14.82 1.45 1.12c.19.19.61.28.89.28h1.77c.56 0 1.17-.42 1.31-.98l1.12-3.42c.23-.65-.19-1.22-.89-1.22h-1.87c-.28 0-.51-.23-.47-.56l.23-1.5c.09-.42-.19-.89-.61-1.03-.37-.14-.84.05-1.03.33l-1.92 2.85"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
