...
const SvgRecordCircle = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M12 16.98a4.98 4.98 0 1 1 0-9.961 4.98 4.98 0 0 1 0 9.961m0-8.46c-1.92 0-3.48 1.56-3.48 3.48s1.56 3.48 3.48 3.48 3.48-1.56 3.48-3.48S13.92 8.52 12 8.52"
    />
  </svg>
);
