...
const SvgImport1 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M12 15.63c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v12.88c0 .42-.34.75-.75.75"
    />
    <path
      fill="currentColor"
      d="M12 16.75c-.19 0-.38-.07-.53-.22l-3.35-3.35a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0L12 14.94l2.82-2.82c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-3.35 3.35c-.15.15-.34.22-.53.22"
    />
  </svg>
);
