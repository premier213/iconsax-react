...
const SvgGlass = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M13.84 15.04c-.66 0-1.37-.09-2.08-.33-2.84-.95-5.77-.85-5.8-.85-.4.06-.76-.31-.78-.72s.31-.76.72-.78c.13-.01 3.24-.11 6.33.92 2.6.87 5.15-.78 5.18-.8.34-.23.81-.13 1.04.21s.14.81-.21 1.04c-.09.07-1.99 1.31-4.4 1.31"
    />
  </svg>
);
