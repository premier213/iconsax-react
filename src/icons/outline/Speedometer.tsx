...
const SvgSpeedometer = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M11.999 22.25c-2.27 0-4.12-1.85-4.12-4.12S9.729 14 11.999 14s4.12 1.85 4.12 4.12-1.85 4.13-4.12 4.13m0-6.75c-1.45 0-2.62 1.18-2.62 2.62s1.18 2.62 2.62 2.62 2.62-1.18 2.62-2.62-1.17-2.62-2.62-2.62M16 12.75h-.75c-.83 0-1.5-.67-1.5-1.5v-.75c0-1.24 1.01-2.25 2.25-2.25s2.25 1.01 2.25 2.25-1.01 2.25-2.25 2.25m0-3c-.41 0-.75.34-.75.75v.75H16c.41 0 .75-.34.75-.75s-.34-.75-.75-.75"
    />
  </svg>
);
