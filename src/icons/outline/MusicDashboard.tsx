...
const SvgMusicDashboard = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M7 22.25c-.41 0-.75-.34-.75-.75v-19c0-.41.34-.75.75-.75s.75.34.75.75v19c0 .41-.34.75-.75.75M11.47 17.55c-1.24 0-2.24-1.01-2.24-2.24a2.25 2.25 0 0 1 2.24-2.24 2.25 2.25 0 0 1 2.24 2.24 2.25 2.25 0 0 1-2.24 2.24m0-2.99c-.41 0-.74.33-.74.74s.33.74.74.74.74-.33.74-.74-.34-.74-.74-.74"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      d="M16.93 16.55c-1.24 0-2.24-1.01-2.24-2.24 0-1.24 1.01-2.24 2.24-2.24a2.25 2.25 0 0 1 2.24 2.24c.01 1.24-1 2.24-2.24 2.24m0-2.98c-.41 0-.74.33-.74.74s.33.74.74.74.74-.33.74-.74-.33-.74-.74-.74M12.96 11.79a.747.747 0 0 1-.19-1.47l5.47-1.49a.75.75 0 1 1 .39 1.45l-5.47 1.49c-.07.01-.14.02-.2.02"
    />
  </svg>
);
