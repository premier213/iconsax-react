...
const SvgMusicSquare = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M14.18 16.81c-1.28 0-2.32-1.04-2.32-2.32s1.04-2.32 2.32-2.32 2.32 1.04 2.32 2.32-1.04 2.32-2.32 2.32m0-3.14c-.45 0-.82.37-.82.82s.37.82.82.82.82-.37.82-.82-.37-.82-.82-.82M9.989 11.79a.747.747 0 0 1-.19-1.47l5.76-1.57a.75.75 0 1 1 .39 1.45l-5.76 1.57c-.07.01-.14.02-.2.02"
    />
  </svg>
);
