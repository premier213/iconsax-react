...
const SvgMicrophoneSlash = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M2.5 22.74c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l19-19c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-19 19c-.15.15-.34.22-.53.22M11.55 6.25c-.41 0-.75-.34-.75-.75V2.26c0-.41.34-.75.75-.75s.75.34.75.75V5.5c0 .42-.34.75-.75.75M8.5 8.25c-.41 0-.75-.34-.75-.75v-4c0-.41.34-.75.75-.75s.75.34.75.75v4c0 .41-.34.75-.75.75"
    />
  </svg>
);
