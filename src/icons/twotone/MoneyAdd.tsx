...
const SvgMoneyAdd = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M9 18c0 .75-.21 1.46-.58 2.06A3.97 3.97 0 0 1 5 22a3.97 3.97 0 0 1-3.42-1.94A3.9 3.9 0 0 1 1 18c0-2.21 1.79-4 4-4s4 1.79 4 4M6.49 17.98H3.51M5 16.52v2.99"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
