...
const SvgForward15Seconds = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M12 22.75c-5.31 0-9.64-4.32-9.64-9.64S6.68 3.47 12 3.47c.69 0 1.39.08 2.15.26.4.09.66.5.56.9-.09.4-.5.66-.9.56-.64-.15-1.24-.22-1.81-.22-4.49 0-8.14 3.65-8.14 8.14s3.65 8.14 8.14 8.14 8.14-3.65 8.14-8.14c0-1.74-.57-3.42-1.65-4.86a.75.75 0 0 1 1.2-.9c1.28 1.7 1.95 3.69 1.95 5.76 0 5.32-4.33 9.64-9.64 9.64"
    />
  </svg>
);
