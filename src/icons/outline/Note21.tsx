...
const SvgNote21 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M13.75 7.25h-3.5c-.8 0-1.55-.31-2.12-.88s-.88-1.32-.88-2.12c0-1.65 1.35-3 3-3h3.5c.8 0 1.55.31 2.12.88s.88 1.32.88 2.12c0 1.65-1.35 3-3 3m-3.5-4.5a1.498 1.498 0 0 0-1.06 2.56c.28.28.66.44 1.06.44h3.5a1.498 1.498 0 0 0 1.06-2.56c-.28-.28-.66-.44-1.06-.44zM12 13.75H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4c.41 0 .75.34.75.75s-.34.75-.75.75M16 17.75H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h8c.41 0 .75.34.75.75s-.34.75-.75.75"
    />
  </svg>
);
