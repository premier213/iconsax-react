...
const SvgShapes = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M13.43 15.75H4.4c-1.12 0-2.14-.58-2.71-1.55s-.59-2.13-.05-3.12l4.51-8.21a3.1 3.1 0 0 1 2.76-1.63c1.17 0 2.2.61 2.76 1.63l4.52 8.21c.54.98.52 2.15-.05 3.12s-1.59 1.55-2.71 1.55m-4.52-13c-.61 0-1.15.32-1.44.85l-4.51 8.21c-.28.52-.27 1.12.02 1.63.3.51.83.81 1.42.81h9.03c.59 0 1.12-.3 1.42-.81s.31-1.11.02-1.63L10.35 3.6c-.29-.53-.83-.85-1.44-.85"
    />
    <path
      fill="currentColor"
