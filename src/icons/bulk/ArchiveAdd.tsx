...
const SvgArchiveAdd = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M14.5 9.9h-1.75V8.21c0-.41-.34-.75-.75-.75s-.75.34-.75.75V9.9H9.5c-.41 0-.75.34-.75.75s.34.75.75.75h1.75v1.81c0 .41.34.75.75.75s.75-.34.75-.75V11.4h1.75c.41 0 .75-.34.75-.75s-.34-.75-.75-.75"
    />
  </svg>
);
