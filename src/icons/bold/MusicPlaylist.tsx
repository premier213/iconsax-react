...
const SvgMusicPlaylist = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M18 5.25H6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h12c.41 0 .75.34.75.75s-.34.75-.75.75M15 2.75H9c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75M13.91 16.21c-.34 0-.62.28-.62.62s.28.62.62.62.62-.28.62-.62-.28-.62-.62-.62M9.51 17.739c0-.34-.28-.61-.62-.61s-.62.28-.62.62.28.62.62.62c.34-.01.62-.29.62-.63"
    />
    <path
      fill="currentColor"
