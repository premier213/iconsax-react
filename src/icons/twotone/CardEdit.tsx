...
const SvgCardEdit = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g
      ...
      opacity={0.4}
    >
      <path d="m19.076 4.13-3.71 3.71c-.14.14-.28.42-.31.62l-.2 1.42c-.07.51.29.87.8.8l1.42-.2c.2-.03.48-.17.62-.31l3.71-3.71c.64-.64.94-1.38 0-2.32-.95-.95-1.69-.65-2.33-.01" />
