...
const SvgTranslate = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M16.92 22a5.08 5.08 0 1 1 .001-10.162A5.08 5.08 0 0 1 16.92 22M5.02 2h3.92c2.07 0 3.07 1 3.02 3.02v3.92c.05 2.07-.95 3.07-3.02 3.02H5.02C3 12 2 11 2 8.93V5.01C2 3 3 2 5.02 2M9.01 5.85H4.95M6.969 5.17v.68"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
