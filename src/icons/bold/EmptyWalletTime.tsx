...
const SvgEmptyWalletTime = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M5 15c-.94 0-1.81.33-2.5.88A3.97 3.97 0 0 0 1 19c0 2.21 1.79 4 4 4a4 4 0 0 0 2.64-1C8.47 21.27 9 20.2 9 19c0-2.21-1.79-4-4-4m1 4.25c0 .26-.14.51-.36.64l-1.25.75c-.12.08-.26.11-.39.11-.25 0-.5-.13-.64-.36-.21-.36-.1-.82.26-1.03l.89-.53v-1.08a.74.74 0 0 1 .74-.75c.41 0 .75.34.75.75zM14.85 3.95v3.8h-1.5v-3.8c0-.27-.24-.4-.4-.4q-.075 0-.15.03L4.87 6.57c-.53.2-.87.7-.87 1.27v.67c-.91.68-1.5 1.77-1.5 3V7.84c0-1.19.73-2.25 1.84-2.67l7.94-3c.22-.08.45-.12.67-.12 1 0 1.9.81 1.9 1.9M21.5 14.5v1a.5.5 0 0 1-.49.5h-1.46c-.53 0-1.01-.39-1.05-.91-.03-.31.09-.6.29-.8a.95.95 0 0 1 .7-.29H21c.29.01.5.23.5.5"
    />
    <path
      fill="currentColor"
