...
const SvgWalletSearch = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M17 22.75h-5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5c2.58 0 4.25-1.67 4.25-4.25v-5c0-2.29-1.42-4-3.54-4.25H7c-.28 0-.38 0-.56.06q-.075.03-.15.03C4.08 8.1 2.75 9.65 2.75 12v1c0 .41-.34.75-.75.75s-.75-.34-.75-.75v-1c0-3.06 1.88-5.27 4.79-5.64.38-.11.66-.11.96-.11h10.8c3 .35 4.95 2.66 4.95 5.75v5c0 3.44-2.31 5.75-5.75 5.75"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      d="M2 22.75c-.19 0-.38-.07-.53-.22a.755.755 0 0 1 0-1.06l1-1c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-1 1c-.15.15-.34.22-.53.22"
    />
  </svg>
);
