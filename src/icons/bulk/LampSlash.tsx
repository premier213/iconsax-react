...
const SvgLampSlash = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M16.63 3.42 5.49 14.56c-.96-1.36-1.52-2.96-1.52-4.51 0-2.45 1.09-4.74 3-6.28s4.41-2.11 6.86-1.57c1.01.22 1.96.64 2.8 1.22M16.17 16.92v.7c.01.26.03.76-.36 1.16-.28.28-.69.43-1.23.43H9.45c-.41 0-.93-.05-1.28-.4-.33-.35-.32-.78-.31-1.06v-.83c-.45-.3-.87-.64-1.25-1.02L17.95 4.56c.5.53.93 1.14 1.26 1.8 2.02 4.06.07 8.47-3.04 10.56"
      opacity={0.4}
    />
  </svg>
);
