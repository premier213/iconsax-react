...
const SvgWalletRemove = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M6.07 20.79c-.19 0-.38-.07-.53-.22l-2.11-2.11a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l2.11 2.11c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22"
    />
    <path
      fill="currentColor"
      d="M3.931 20.82c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l2.11-2.11c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-2.11 2.11c-.15.15-.34.22-.53.22"
    />
  </svg>
);
