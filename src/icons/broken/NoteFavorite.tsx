...
const SvgNoteFavorite = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M8 2v3M16 2v3M3 8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5v5.13a5.2 5.2 0 0 0-3.25-1.13c-1.23 0-2.38.43-3.28 1.16a5.19 5.19 0 0 0-1.97 4.09c0 .98.28 1.92.76 2.7.37.61.85 1.14 1.42 1.55H8c-3.5 0-5-2-5-5v-4.43M7 11h6M7 16h2.62"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
