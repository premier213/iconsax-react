...
const SvgClipboardExport = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M14.35 2h-4.7c-1.04 0-1.89.84-1.89 1.88v.94c0 1.04.84 1.88 1.88 1.88h4.71c1.04 0 1.88-.84 1.88-1.88v-.94C16.24 2.84 15.39 2 14.35 2M15.53 16.47l-4.72-4.72H12c.41 0 .75-.34.75-.75s-.34-.75-.75-.75H9c-.41 0-.75.34-.75.75v3c0 .41.34.75.75.75s.75-.34.75-.75v-1.19l4.72 4.72c.15.15.34.22.53.22s.38-.07.53-.22c.29-.29.29-.77 0-1.06"
    />
  </svg>
);
