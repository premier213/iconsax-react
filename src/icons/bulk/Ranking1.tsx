...
const SvgRanking1 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M6 9.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v7c0 .41-.34.75-.75.75M18 9.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v7c0 .41-.34.75-.75.75M12 4.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 .41-.34.75-.75.75"
      opacity={0.4}
    />
  </svg>
);
