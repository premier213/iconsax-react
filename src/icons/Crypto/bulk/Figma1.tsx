...
const SvgFigma1 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M12 8.67H8.67c-1.84 0-3.33 1.49-3.33 3.33s1.49 3.33 3.33 3.33H12z"
      opacity={0.4}
    />
    <path
      fill="currentColor"
      d="M12 15.33H8.67c-1.84 0-3.33 1.49-3.33 3.33s1.49 3.33 3.33 3.33S12 20.5 12 18.66z"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      d="M15.33 8.67c1.84 0 3.33 1.49 3.33 3.33s-1.49 3.33-3.33 3.33S12 13.84 12 12s1.49-3.33 3.33-3.33"
    />
  </svg>
);
