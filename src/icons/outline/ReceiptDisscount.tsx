...
const SvgReceiptDisscount = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M15 14c-.56 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.44 1-1 1M9 9c-.56 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.44 1-1 1M8.63 14.55c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l6.73-6.73c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-6.73 6.73a.7.7 0 0 1-.53.22"
    />
  </svg>
);
