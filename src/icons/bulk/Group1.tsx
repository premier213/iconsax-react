...
const SvgGroup1 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M2.08 5.25H1c-.41 0-.75.34-.75.75s.34.75.75.75h1V6c0-.26.03-.51.08-.75M1 8.25c-.41 0-.75.34-.75.75s.34.75.75.75h1v-1.5zM1 11.25c-.41 0-.75.34-.75.75s.34.75.75.75h1v-1.5z"
    />
  </svg>
);
