...
const SvgGemini = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="m19.23 4.18.13-.24a.76.76 0 0 0-.09-.85.74.74 0 0 0-.83-.21 18.76 18.76 0 0 1-12.88 0 .74.74 0 0 0-.83.21c-.2.24-.24.57-.09.85l.13.23a16.83 16.83 0 0 1-.1 15.88.76.76 0 0 0 .09.85c.2.24.53.32.82.21 4.13-1.51 8.69-1.51 12.83 0 .08.03.17.05.26.05.21 0 .42-.09.57-.26.2-.24.24-.57.09-.85a16.83 16.83 0 0 1-.1-15.87"
    />
    <path
      fill="currentColor"
